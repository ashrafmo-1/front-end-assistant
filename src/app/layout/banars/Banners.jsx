...
export default function Banner() {
  ...
  return (
    <div className="banar relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
      ...
      <div className="flex flex-1 justify-end" onClick={() => removeBanner()}>
