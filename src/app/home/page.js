    ...
    <section className="home h-screen relative" id="landing">
        <div className="landing w-4/5 m-auto flex justify-center content-center flex-col mediaContiner">
          ...
          >
            ...
            auxiliary tools, This is your right place.
          </h1>
          <p
            className="description text-zinc-600 mt-7 text-center"
            style={{ color: "var(--description_color)" }}
          >
            If you are a designer, programmer or even an ordinary person, your
            needs are met here.
          </p>
          <div className="btns w-fit m-auto mt-6 flex gap-4">
            <Link
              href={""}
              className="allFu bg-slate-900 text-2xl py-1 px-4 capitalize rounded"
              style={{ color: "var(--text_color)" }}
            >
              all features
            </Link>
          ...
          <div className="animationScroll"></div>
          <div className="sea">
